...
namespace OrmBenchmarkThesis.Benchmarks
{
    ...
    [MemoryDiagnoser]
    public class SelectPeopleBenchmarkPostgres : OrmBenchmarkBase

    {
        //robimy tylko przed pierwszym benchmarkiem RepoDB, bo mapowania nie mozna wykonac kilkukrotnie ( to dla postgresql )
